...
class KStacks:
    ...
    def __init__(self, k, n):
        ...
        self.arr = [0] * self.n
        print("Array Size:",self.arr)

        # All stacks are empty to begin with
        # (-1 denotes stack is empty).
        self.top = [-1] * self.k
        print("Top for 3 Stack :",self.top)

        # Top of the free stack.
        self.free = 0
        print("Top of Stack:",self.free)
    ...
    def pop(self, sn):
        ...
        print("Move top to next:",self.top[sn],":",self.next[self.top[sn]])

        # Push the old top_of_stack to
        # the 'free' stack.
        self.next[top_of_stack] = self.free
        print("Top element:",self.next[top_of_stack])
